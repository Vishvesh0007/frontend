...
const AdminPanel = () => {
  ...
  const fetchStats = async () => {
    const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/dashboard-stats`, {
  ...
  const fetchActivityLogs = async () => {
    const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/activity-logs?limit=10`, {
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  const fetchPickupRequests = async () => {
    ...
    const res = await axios.get(
      `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/pickup-requests?${params.toString()}`,
      { headers: { Authorization: `Bearer ${token}` } },
    );
  ...
  const handleOpportunitiesReport = async () => {
    const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/opportunities`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    const data = res.data || [];
  ...
  const handleActivityReport = async () => {
    const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/activity-logs?limit=5000`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    const data = res.data || [];
  ...
  const deleteUser = async (id) => {
    await axios.delete(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/users/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    fetchUsers();
  };
  ...
  const saveUserEdits = async () => {
    ...
    await axios.put(
      `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/users/${editingUser._id}/edit`,
      editForm,
      { headers: { Authorization: `Bearer ${token}` } },
    );
    setEditingUser(null);
  ...
  const toggleSuspend = async (id) => {
    await axios.put(
      `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/users/${id}/suspend`,
      {},
      { headers: { Authorization: `Bearer ${token}` } },
    );
    fetchUsers();
  ...
  const toggleBlockV2 = async (id) => {
    await axios.put(
      `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/admin/users/${id}/block`,
      {},
      { headers: { Authorization: `Bearer ${token}` } },
    );
    fetchUsers();
